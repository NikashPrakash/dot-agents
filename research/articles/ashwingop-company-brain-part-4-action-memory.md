## ashwingop — Company Brain, Part 4: Action Memory

**Source**: https://x.com/ashwingop/status/2051317871750558077
**Author**: Ashwin Gopinath (@ashwingop) — CEO of Sentra.app; former MIT Prof; 2x founder
**Date**: 2026-05-04
**Method**: Playwright
**Word count**: ~1,400 words
**Engagement**: 2 replies, 29 reposts, 299 likes, 678 bookmarks, 21.7K views

---

### Summary

Part 4 of the "Company Brain" series argues that action memory — the layer that remembers how a company moves, not just what it knows — is the most operationally complex and agentically active of the three memory layers. It distinguishes four sub-types (procedural, trigger, execution, outcome memory) and argues that agents can only be trusted when they know when to do nothing rather than when to act.
...
Part 3: Interaction Memory — https://x.com/ashwingop/status/2050963469898506342

---

### Key Quotes

> "The most important thing a Company Brain can do at the action layer is not act. Most automation systems act because they can. A useful system acts because the context says it should, and stays still when it should not. Doing nothing is a first-class action."

> "If a Company Brain cannot do nothing on purpose, it cannot be trusted to do anything on purpose."

> "Most workflow diagrams are polite fiction: they show the official process, not the real one."

> "Action memory is what lets the company say: when this happens, here is who should care, here is what usually happens next, and here is where the system should be careful. It is the difference between remembering a process and noticing that the process has become relevant."

> "Most CEOs feel this and cannot point at it. Action memory is what makes it pointable."
