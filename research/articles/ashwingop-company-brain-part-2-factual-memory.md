...
**Source**: https://x.com/i/article/2049877146936786944
**Author**: Ashwin Gopinath (@ashwingop)
**Date**: 2026-04-30
**Method**: Playwright
**Word count**: ~1450 words
**Related**: https://x.com/ashwingop/status/2049885545288077720

---

### Summary

Ashwin Gopinath argues that factual memory is the first layer of a real "Company Brain": the part that helps an organization answer what exists, what changed, who owns what, and where the supporting evidence lives. The piece rejects the idea that company memory can be reduced to a central repository or basic enterprise RAG, and instead argues for an emergent, permission-aware semantic memory layer built from individual work becoming team and institutional memory. It also emphasizes that durable factual memory must be proactive, role-aware, and grounded in provenance, ownership, freshness, and relationships between artifacts.
...
> "Factual memory is not a shared drive. It is not a wiki. It is not enterprise search with a chat box attached."

> "People do not work in repositories. They work in docs, Slack, meetings, tickets, local notes, spreadsheets, CRM systems, design tools, GitHub, and email."
...
The direct article URL redirected to X login when opened anonymously. The body text above was extracted from the linked post's GraphQL response, which exposed the article title, metadata, preview, summary, and plaintext content blocks.
