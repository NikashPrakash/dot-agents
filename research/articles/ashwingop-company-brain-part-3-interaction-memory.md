...
**Author**: Ashwin Gopinath (@ashwingop) — CEO of Sentra.app; ex-MIT Professor; 2x founder
**Date**: 2026-05-03
**Method**: Playwright
**Word count**: ~1,450 words
**Engagement**: 2 replies · 14 reposts · 161 likes · 404 bookmarks · 11.7K views
**Series:**
- Part 1: [Why most companies have data but no memory](https://x.com/ashwingop/status/2049641901410955694)
- Part 2: [Factual Memory](https://x.com/ashwingop/status/2049885545288077720) — already extracted at `ashwingop-company-brain-part-2-factual-memory.md`
- Part 3: this article (Interaction Memory)
- Part 4 (announced, not published): Action Memory

---

### Summary

Gopinath argues that **interaction memory** is the second layer of a real "Company Brain" — the layer that turns meetings, messages, calls, and emails into structured organizational reasoning. Where factual memory remembers *artifacts* (what exists, who owns it, when it changed), interaction memory remembers *what happened between people before the artifact existed* — the why, the constraints, the fragile assumptions, and what was left unsaid. The hard problem is **interpretation, not capture**: a transcript or summary is insufficient. The system needs an **ontology** — a shared set of concepts (decision, commitment, objection, escalation, dependency, assumption, customer pain, owner, precedent, open question) — and the company has to be able to **reread its own past** as that ontology evolves. Interaction memory feeds a **context graph** linking people, teams, customers, projects, commitments, decisions, risks, assumptions, dependencies, and time. The end goal is a system that proactively notices patterns no individual is holding in their head: same objection across three customer calls, two teams using conflicting metric definitions, decisions reopened because the original tradeoff was never recorded, owners implied but never named.
...
> "Interaction is the chain of thought of the organization. It is the trace of how a group moved from partial information to judgment."

> "If factual memory is the company remembering its artifacts, interaction memory is the company remembering how meaning was created."

> "Ontology is the word for this problem. … In a company, the ontology decides whether something in a conversation is a decision, commitment, objection, escalation, dependency, assumption, customer pain, owner, precedent, or open question. Those labels are not just metadata. They decide what gets remembered."

> "The meaning of an interaction depends on the ontology used to interpret it. Change the ontology, and the same interaction can mean something different. … The company has to be able to reread its own past."

> "Too little memory, and the company keeps forgetting why things happened. Too much memory, and the system becomes noisy or creepy."

> "The diagram version of this is clean. The real version is messy."

> "Without it, agents will keep operating downstream of incomplete context."
